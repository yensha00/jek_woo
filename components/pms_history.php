...
<!-- Modal -->
<div class="modal fade" id="pms-history-form" tabindex="-1" aria-labelledby="formLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="pms-history-title fs-5" id="formLabel">DC/LC ASSET PMS HISTORY</h1>
